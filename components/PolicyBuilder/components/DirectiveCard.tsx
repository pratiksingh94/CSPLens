      ...
      <div className="flex items-center gap-2 p-2.5">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5">
            ...
            {isDirectiveImportant(directive.name) && !state.enabled && (
        ...
        <button
          ...
          className={cn(
            "p-1 rounded hover:bg-muted transition-transform cursor-pointer",
